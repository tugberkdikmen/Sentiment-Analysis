...
df = pd.read_csv('archive/olist_order_reviews_dataset.csv')
...
tokenizer.fit_on_texts(train_df['review_comment_message'])
max_length = max([len(x.split()) for x in train_df['review_comment_message']])
X_train_pad = pad_sequences(tokenizer.texts_to_sequences(train_df['review_comment_message']), maxlen=max_length)
X_val_pad = pad_sequences(tokenizer.texts_to_sequences(val_df['review_comment_message']), maxlen=max_length)
X_test_pad = pad_sequences(tokenizer.texts_to_sequences(test_df['review_comment_message']), maxlen=max_length)
